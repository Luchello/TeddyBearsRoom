...
export default function HomePage() {
  return (
    <div className="flex flex-col">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 rounded-full bg-accent/50 px-4 py-2 text-sm font-medium text-accent-foreground">
                <span>🧸</span>
                <span>TeddyBear&apos;s Room에 오신 것을 환영해요</span>
              </div>
              <h1 className="text-4xl font-bold tracking-tight text-foreground lg:text-6xl">
                <span className="text-primary">파스텔 감성</span>의<br />
                프라이빗 셀프케어
              </h1>
            ...
            <div className="relative">
              <div className="aspect-square rounded-3xl bg-gradient-to-br from-primary/20 to-secondary/20 p-8 flex items-center justify-center">
                <span className="text-[200px] animate-bounce">🧸</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Subscription CTA */}
      <section className="bg-gradient-to-r from-primary/10 via-accent/10 to-secondary/10 py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-12">
            {subscriptionBenefits.map((benefit, index) => (
              <Card key={index} className="rounded-2xl border-border bg-card/50 backdrop-blur">
