  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-16 grid-bg">
        {/* Background Elements */}
        <div className="absolute inset-0 bg-gradient-to-b from-pink-50/50 via-purple-50/30 to-green-50/20 dark:from-[#1A1025] dark:via-[#1F1530] dark:to-[#1A1025] z-0" />
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8 relative z-10">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <h1 className="font-display text-5xl lg:text-7xl font-black tracking-tighter leading-[1.1] text-foreground">
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-green-400 dark:from-[#FF85B3] dark:via-[#C4B5FD] dark:to-[#B8E6C8] animate-gradient-x">
                Soft Outside,
              </span>
      ...
      <section className="py-24 relative z-10 dark:bg-[#1A1025]">
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          <Button
            asChild
            variant="ghost"
            className="group text-lg font-medium hover:bg-transparent hover:text-primary p-0 dark:text-[#FF85B3] dark:hover:text-[#FF85B3]/80"
          >
      ...
      <section className="py-24 relative overflow-hidden dark:bg-gradient-to-b dark:from-[#1A1025] dark:via-[#1F1530] dark:to-[#1A1025]">
        <div className="absolute inset-0 bg-primary/5 dark:bg-transparent -skew-y-3 transform origin-top-left scale-110" />

        <div className="mx-auto max-w-7xl px-4 lg:px-8 relative z-10">
          {/* P1: rounded-[2.5rem] = --radius-2xl (40px) - Design Token 표준화 */}
          <div className="bg-white dark:bg-[#251A35] rounded-[2.5rem] p-8 md:p-16 shadow-2xl border border-primary/10 dark:border-[#3D2E55] dark:rounded-2xl overflow-hidden relative">
            {/* Decorative Blobs */}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-foreground dark:text-white leading-tight section-heading">
                  Become a <br />
                  <span className="text-primary dark:text-[#FF85B3] dark:drop-shadow-[0_0_8px_rgba(255,105,180,0.5)]">Roommate</span>
                </h2>
              ...
              <div className="relative">
                <div className="aspect-[4/5] rounded-[2.5rem] bg-neutral-100 dark:bg-[#2A1F3A] dark:rounded-2xl dark:border dark:border-[#3D2E55] overflow-hidden relative group">
                ...
                {/* Floating Elements */}
                <div className="absolute -bottom-6 -right-6 bg-white dark:bg-[#251A35] dark:border-[#3D2E55] p-6 rounded-3xl shadow-xl border border-primary/10 animate-float">
