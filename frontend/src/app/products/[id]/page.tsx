      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="relative">
            <div className="aspect-square rounded-3xl bg-gradient-to-br from-primary/10 to-secondary/10 flex items-center justify-center overflow-hidden relative">
            ...
            <div className="absolute top-4 right-4 flex flex-col gap-2">
              <button
                className="p-3 rounded-full bg-background/80 backdrop-blur hover:bg-background transition-colors shadow-lg"
                aria-label="찜하기"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center p-3 rounded-xl bg-muted/50">
                ...
                <p className="text-xs text-muted-foreground mt-1">무료배송</p>
              </div>
              <div className="text-center p-3 rounded-xl bg-muted/50">
                <span className="text-2xl">🔒</span>
                <p className="text-xs text-muted-foreground mt-1">프라이버시</p>
              </div>
              <div className="text-center p-3 rounded-xl bg-muted/50">
                <span className="text-2xl">💝</span>
                <p className="text-xs text-muted-foreground mt-1">포인트 적립</p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-primary/10 border border-primary/20">
              <p className="text-sm">
                <span className="font-bold text-primary">🐻 구독자 혜택</span>
                <br />
