        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-muted-foreground hover:text-primary transition-colors dark:hover:neon-text">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              {footerLinks.shop.map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="text-sm text-muted-foreground hover:text-primary transition-colors dark:hover:neon-text">
                    {link.name}
                  </Link>
                </li>
              ))}
